...
@objc extension UITableView: ListLoadable {
    public func ld_visibleContentViews() -> [UIView] {
        return (self.visibleCells as NSArray).value(forKey: "contentView") as! [UIView] // swiftlint:disable:this force_cast
    }
}
...
@objc extension UIView {
    public func showLoader() {
        ...
        if self is UITableView {
            ListLoader.addLoaderTo(self as! UITableView) // swiftlint:disable:this force_cast
        } else if self is UICollectionView {
            ListLoader.addLoaderTo(self as! UICollectionView) // swiftlint:disable:this force_cast
        } else {
    ...
    public func hideLoader() {
        ...
        if self is UITableView {
            ListLoader.removeLoaderFrom(self as! UITableView) // swiftlint:disable:this force_cast
        } else if self is UICollectionView {
            ListLoader.removeLoaderFrom(self as! UICollectionView) // swiftlint:disable:this force_cast
        } else {
...
@objc extension UIView {
    fileprivate func ld_getCutoutView() -> UIView? {
        return objc_getAssociatedObject(self, &cutoutHandle) as! UIView? // swiftlint:disable:this force_cast
    }
    ...
    fileprivate func ld_getGradient() -> CAGradientLayer? {
        return objc_getAssociatedObject(self, &gradientHandle) as! CAGradientLayer? // swiftlint:disable:this force_cast
    }
    ...
    func configureAndAddAnimationToGradient(_ gradient: CAGradientLayer) {
        ...
        let startLocations = [NSNumber(value: gradient.startPoint.x.doubleValue() as Double), NSNumber(value: gradient.startPoint.x.doubleValue() as Double),
        ...
        gradientAnimation.toValue = [NSNumber(value: 0 as Double),
                                     ...
                                     NSNumber(value: 1 as Double),
                                     NSNumber(value: 1 + (gradientWidth - gradientFirstStop) as Double), NSNumber(value: 1 + gradientWidth as Double)]
