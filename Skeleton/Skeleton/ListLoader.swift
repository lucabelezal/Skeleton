...
//
//        for view in (self.superview?.subviews)! { // swiftlint:disable:this force_cast
//
//            if view != self {
...
//        self.superview?.ld_getGradient()?.frame = (self.superview?.bounds)! // swiftlint:disable:this force_cast
//    }
//}
//
